...
<div id="content">
    ...
    <div id="content-header">
      ...
      <h1><img src="{{ asset('images/checkin.png') }}"  />Reserved</h1>
                                                ...
                                                <table class="table table-bordered table-invoice table-striped" style="margin-top: -1.5em">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td colspan="10">
                                                                    <a href="{{ url('/multiple_reservation/getdateR/.$customer->rsvn_no') }}" class="btn btn-primary pull-right"><i class="icon-calendar"></i> Set Another Date</a>
                                                                </td>
