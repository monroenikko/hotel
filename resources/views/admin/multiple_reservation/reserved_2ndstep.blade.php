...
<div id="content">
    ...
    <div id="content-header">
      ...
      <h1><img src="{{ asset('images/checkin.png') }}"  />Reserve</h1>
                                                        ...
                                                        <tbody>
                                                            @foreach($getIdRoom as $book)
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <center>
                                                                            <a href="{{ url('/void-room/'.$book->bookingID) }}" class="btn btn-danger btn-mini deletedata"><i class="icon-trash"></i></a>
                                                                        </center>
                                                                    </td>
                                                                </tr>
                                                            @endforeach
                    ...
                    <div class="span6">
                            <div class="widget-box" >
                                    <div class="widget-title"> <span class="icon"> <i class="icon-info-sign"></i> </span>
                                        ...
                                        <a style="margin-top:2px; margin-bottom: 3px; margin-right: 3px" href="{{ url('/setDateAnotherRoom/'.$customer->customer_rsvnno) }}" class="btn btn-primary pull-right"><i class="icon-calendar"></i> Set Another Date</a>
                                    </div>
