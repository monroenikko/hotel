            ...
            <div class="span8">
                        ...
                        <div class="widget-box" >
                            ...
                            <div class="widget-content nopadding">
                                <form class="form-horizontal" method="post" action="{{ url('/multiple_reservation/getdateOccupy/'.str_pad($lastBooking->booking_rsvn_no, 10, '0', STR_PAD_LEFT) ) }}" name="checkin" id="checkin" novalidate="novalidate">{{ csrf_field() }}
