...
<div id="content">
    ...
    <div id="content-header">
      ...
      <h1><img src="{{ asset('images/checkin.png') }}"  />Occupy Room</h1>
                                                        ...
                                                        <tr>
                                                            <tr>
                                                                <td colspan="2"><i class="icon-info-sign"></i> Occupy Transaction Details:
                                                                    ...
                                                                    <a href="{{ url('/multiple_occupy/print1/'.$customer->customer_rsvnno) }}" target="_blank" class="btn btn-success pull-right"><i class="icon-print"></i> Print</a></td>
                                                            </tr>
                                                                <tr>
                                                        ...
                                                        <tbody>
                                                            @foreach($getIdRoom as $book)
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <center>
                                                                            <a href="{{ url('/voidOccupy-room/'.$book->bookingID) }}" class="btn btn-danger btn-mini deletedata"><i class="icon-trash"></i></a>
                                                                        </center>
                                                                    </td>
                                                                </tr>
                                                            @endforeach
                    ...
                    <div class="span6">
                            <div class="widget-box" >
                                    <div class="widget-title"> <span class="icon"> <i class="icon-info-sign"></i> </span>
                                        ...
                                        <a href="{{ url('/multiple_reservation/setdate/'.$customer->customer_rsvnno) }}" style="margin-top: 3px; margin-right: 7px; margin-bottom: 4px" class="btn btn-primary pull-right"><i class="icon-calendar"></i> Set Another Date</a>
