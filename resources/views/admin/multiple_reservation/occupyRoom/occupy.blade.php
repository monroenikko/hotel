                        ...
                        {{--  <div class="container-fluid">  --}}
                                <div class="widget-box" >
                                    ...
                                    <div class="widget-content nopadding">
                                        <form class="form-horizontal" method="post" action="{{ url('/multiple_reservation/getOccupy/'.$rs = $lastBooking->booking_rsvn_no + 1) }}" name="occupy_room" id="occupy_room" novalidate="novalidate">{{ csrf_field() }}
                                            ...
                                            <div class="form-actions">
                                                <input type="submit"  onclick="reserve(event);" value="Occupy" class="btn btn-success pull-right">
                                            </div>
                                        </form>
                                    </div>
                                </div>
