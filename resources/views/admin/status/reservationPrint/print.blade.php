 ...
 <br />
    <div class="table-responsive">
        ...
        <tr>
                ...
                <th style="width: 10px">No. Rooms</th>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td> PHP <?php
                    ...
                    $formattedNum = number_format($result = $book->booking_rate - $book->booking_downpayment, 2);
                    echo $formattedNum;
                    ?>
                </td>
            ...
            <tr>
                <td colspan="10" style="text-align: right; font-size: 12px">
                        ...
                        <b><?php
                                  $formattedNum = number_format($totalpayment, 2);
                                  echo $formattedNum;
                              ?>
                          </b>
                </td>
