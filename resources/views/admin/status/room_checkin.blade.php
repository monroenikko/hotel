...
<div id="content">
    ...
    <div id="content-header">
      ...
      <h1><img src="{{ asset('images/checkin.png') }}"  />Check-in the Room {{ $manages->room_no }} ({{ $manages->room_type }})</h1>
    ...
    <div class="row-fluid">
            <div class="span7" id="2nd" style="display: none">
                    {{--  <div class="container-fluid">  --}}
                            <div class="widget-box" >
                                ...
                                <div class="widget-content nopadding">
                                    <form class="form-horizontal" method="post" action="{{ url('/status/occupy-room/'.$manages->id)}}" name="occupy_room" id="occupy_room" novalidate="novalidate">{{ csrf_field() }}

                                        <input type="hidden"  class="span11" name="result_id1" id="result_id1">

                                            {{--  <label class="control-label">RSVN Number</label>  --}}

                                            <p id="rsvn_no" style="display: none">
                                                {{ str_pad($booking->booking_rsvn_no, 10, '0', STR_PAD_LEFT) }}
                                            </p>
        ...
        <div class="row-fluid">
            <div class="span7" id="4th" style="display: none">
                        ...
                        <div class="widget-box" >
                            ...
                            <div class="widget-content nopadding">
                                <form class="form-horizontal" method="post" action="{{ url('/status/add-reserve/'.$manages->id) }}" name="checkin" id="checkin" novalidate="novalidate">{{ csrf_field() }}
                                        ...
                                        {{--  <label class="control-label" for="room_rate2">Room Rate ₱</label>  --}}
                                            ...
                                            <p id="room_rate1" style="display: none">{{ $manages->room_rate }}</p>
            ...
            <div class="span5" id="6th" style="margin-top: 1.3em; display:none">
                <table class="table table-bordered table-invoice table-striped">
                    <tbody>
                        <tr>
                            <tr>
