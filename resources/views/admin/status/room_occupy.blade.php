                                        ...
                                        @foreach($hotels as $hotelex)
                                            <tr class="gradeX">
                                                ...
                                                <td class="center" colspan="2">
                                                        ...
                                                        <form action=""></form>
                                                        <form method="POST" action="{{ url('/status/getextra/'.$hotelex->hotex_id) }}" name="cust_extra" id="cust_extra" novalidate="novalidate">
                                                            ...
                                                            <input style="margin-top: -.8em; margin-left: 5em" type="submit" id="add_it" value="+" class="btn btn-primary btn-mini">{{ csrf_field() }}
                                                        </form>
                            ...
                            <tbody>
                                    @foreach($CustomerExtra as $Cust)
                                        <tr class="gradeX">
                                            ...
                                            <td class="center">
                                                <center>
                                                     <a href="{{ url('/status/delete-extra/'.$Cust->extra_id) }}" class="btn btn-danger btn-mini deletedata"><i class="icon-trash"></i></a>
                                                </center>
                                            </td>
