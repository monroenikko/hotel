...
<div id="content">
    ...
    <div id="content-header">
      ...
      <h1><img src="{{ asset('images/checkin.png') }}"  />Reserved1</h1>
                                        ...
                                        {{--  <label class="control-label" for="room_rate2">Room Rate ₱</label>  --}}
                                            ...
                                            <table class="table table-bordered table-invoice table-striped">
                                                    <tbody>
                                                        <tr>
                                                            <tr>
                                                                <td colspan="2"><i class="icon-info-sign"></i> Reserved Transaction Details:
                                                                    <input type="button" id="another_transaction" class="btn btn-primary pull-right" value=" Reserve Another Room">
                                                                    <a href="{{ url('/multiple_reservation/print/'.$customer->customer_rsvnno) }}" target="_blank" class="btn btn-success pull-right"><i class="icon-print"></i> Print</a></td>
                                                            </tr>
                                                                <tr>
                                                                    <td style="width:140px"><b>RSVN NO.</b></td>
                                                                    <td> <b>{{ str_pad( $manages->rsvn_no , 10, '0', STR_PAD_LEFT) }}</b></td>
                                                                </tr>
                                                                <tr>
                                                ...
                                                <table class="table table-bordered table-invoice table-striped" style="margin-top: -1.5em">
                                                        <thead>
                                                            <tr>
                                                                <th style="width: 60px">Date Arrival</th>
                                                                <th style="width: 60px">Date Departure</th>
                                                                <th>Room Type</th>
                                                                <th style="width: 30px">Room No.</th>
                                                                <th style="width: 30px">Total Night(s)</th>
                                                                <th>Rate/Night(s)</th>
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td><center>{{ $book->bookingroomcategory }}</center></td>
                                                                ...
                                                                <td>
                                                                    <center>
                                                                        ...
                                                                        <a href="{{ url('/occupyReserve-room/'.$book->bookingID) }}" onclick="occupyRoom(event);" class="btn btn-primary btn-mini "><i class="icon-check"></i> Occupy</a>


                                                                        <a href="{{ url('/void-room1/'.$book->bookingID) }}" onclick="deleteRoom(event);" class="btn btn-warning btn-mini "><i class="icon-remove-circle"></i> Cancel Reserve</a>
                                                                    </center>
                                                                </td>
                                                            </tr>
                                                        @endforeach
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td colspan="11">
                                                                        ...
                                                                        <a href="{{ url('/viewApplication/'.$customer->customer_rsvnno) }}"  onclick="occupyRoom(event);" class="btn btn-primary pull-right"><i class="icon-check"></i> Occupy All Room</a>

                                                                        <a href="{{ url('/void-Allroom/'.$manages->rsvn_no) }}"  onclick="voidAll(event);"  class="btn btn-danger pull-right"><i class="icon-remove-sign"></i> Cancel All Room</a>
    ...
    <div class="container-fluid" style="display:none" id="room-available">
            ...
            <div class="row-fluid">
                    <div class="span6">
                            <div class="widget-box" >
                                    <div class="widget-title"> <span class="icon"> <i class="icon-info-sign"></i> </span>
                                        <h5>Reserved Room Available Information</h5>

                                        <a style="margin-top: 3px; margin-bottom: 3px; margin-right: 5px" href="{{ url('/setDate/'.$manages->rsvn_no) }}" class="btn btn-primary pull-right"><i class="icon-calendar"></i> Set Another Date</a>
                                    </div>
                                        ...
                                        <tbody>
                                            @foreach($hotelRoom as $room)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <center>
                                                                <form method="POST" action="{{ url('/multiple_reservation/reservedroom/'.$customer->customer_rsvnno)}}" name="cust_extra" id="cust_extra" novalidate="novalidate">
...
<script>
        ...
        function voidAll(e)
        {
            if(!confirm('Are you sure you want to Cancel All the Reserved Room?'))e.preventDefault();
        }

        function occupyRoom(e)
        {
            if(!confirm('Are you sure you want to Occupy all Room?'))e.preventDefault();
        }

        function deleteRoom(e)
        {
            if(!confirm('Are you sure you want to Delete the Reserved Room?'))e.preventDefault();
        }

        function cancelReserve(e)
        {
            if(!confirm('Are you sure you want to Cancel the Reserved Room?'))e.preventDefault();
        }

        function occupyReserve(e)
        {
            if(!confirm('Are you sure you want to Occupy the Reserved Room?'))e.preventDefault();
        }
