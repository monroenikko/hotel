            ...
            <div class="span8">
                        ...
                        <div class="widget-box" >
                            ...
                            <div class="widget-content nopadding">
                                <form class="form-horizontal" method="post" action="{{ url('/multiple_reservation/getdateReserve/'.str_pad($lastBooking->booking_rsvn_no, 10, '0', STR_PAD_LEFT)) }}" name="checkin" id="checkin" novalidate="novalidate">{{ csrf_field() }}
                                        ...
                                        <div class="control-group ">
                                            ...
                                            <div class="controls">
                                                <input type="hidden"  class="" name="result_rsvn_no" id="result_rsvn_no" value="{{ str_pad($lastBooking->booking_rsvn_no, 10, '0', STR_PAD_LEFT) }}">
                                                <input type="text" disabled="" class="span11" id="resulRsvn" value="{{ str_pad($id, 10, '0', STR_PAD_LEFT) }}">
                                            </div>
                                        </div>
