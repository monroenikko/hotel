...
<div id="content">
    ...
    <div id="content-header">
      ...
      <h1><img src="{{ asset('images/checkin.png') }}"  />Reserved2</h1>
                                                ...
                                                <table class="table table-bordered table-invoice table-striped" style="margin-top: -1.5em">
                                                        ...
                                                        <tbody>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <center>
                                                                            ...
                                                                            <a href="{{ url('/cancelReserve-room/'.$book->bookingID) }}" onclick="cancelReserve(event);" class="btn btn-danger btn-mini "><i class="icon-trash"></i> Cancel Reserve</a>


                                                                            <a href="{{ url('/void-room/'.$book->bookingID) }}" onclick="deleteRoom(event);"  class="btn btn-warning btn-mini deletedata"><i class="icon-trash"></i> Delete</a>
                                                                        </center>
                                                                    </td>
                                                                </tr>
                                                            @endforeach
                                                            <tr>
                                                                ...
                                                                <td colspan="9">
                                                                    <center>
                                                                        <a href="{{ url('/viewApplication/'.$customer->customer_rsvnno) }}"  onclick="occupyRoom(event);"  class="btn btn-danger pull-right"><i class="icon-check"></i> Occupy All room</a>
                                                                    </center>
                                                                </td>

                                                                <td>
                                                                    <center>
                                                                        <a href="{{ url('/void-Allroom/'.$customer->customer_rsvnno) }}" onclick="voidAll(event);" class="btn btn-danger"><i class="icon-remove-sign"></i> Cancel All the Reservation Room</a>
                                                                    </center>
                                                                </td>
                    ...
                    <div class="span6">
                            <div class="widget-box" >
                                    <div class="widget-title"> <span class="icon"> <i class="icon-info-sign"></i> </span>
                                        ...
                                        <a style="margin-top: 3px; margin-bottom: 3px; margin-right: 5px" href="{{ url('/setDate/'.$customer->customer_rsvnno) }}" class="btn btn-primary pull-right"><i class="icon-calendar"></i> Set Another Date</a>
                                    </div>
...
<script>
        ...
        function voidAll(e)
        {
            if(!confirm('Are you sure you want to Cancel the Reservation Room?'))e.preventDefault();
        }
