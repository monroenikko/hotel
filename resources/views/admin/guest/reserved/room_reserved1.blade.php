            ...
            <div class="span7">
                            ...
                            <div class="widget-box">
                                ...
                                <div class="widget-content nopadding">
                                    <form class="form-horizontal" method="post" action="{{ url('/Occupy-Oneroom/'.$booking->bookingID )}}" name="reserve_room" id="reserve_room" novalidate="novalidate">{{ csrf_field() }}
