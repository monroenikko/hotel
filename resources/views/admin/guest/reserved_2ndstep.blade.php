                    ...
                    <div class="span6">
                            <div class="widget-box" >
                                    <div class="widget-title"> <span class="icon"> <i class="icon-info-sign"></i> </span>
                                        ...
                                        <a style="margin-top:2px; margin-bottom: 3px; margin-right: 3px" href="{{ url('/setDateAnotherRoom/.$customer->rsvn_no') }}" class="btn btn-primary pull-right"><i class="icon-calendar"></i> Set Another Date</a>
                                    </div>
